                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body ">
                                    <form class="form" action="{{route('resume_submit')}}" method="post"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="client" id="clientname">
                                                            ...
                                                            <option value="{{$client_names->id}}">
                                                                {{($client_names->client_na)->client_name}}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('client')
            ...
            <div class="card">
                <div class="card-content collapse show">
                    <div class="card-body">
                        ...
                        <form class="form" action="{{route('insert_resume')}}" method="post"
                            enctype="multipart/form-data">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="position"
                                                            value="{{session('job_name')}}" disabled>
                                                        @endif
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="">Other Vital Information(Position
                                                                        Specific)</label>
                                                                    <textarea class="form-control"
                                                                        name="vital_information"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                            ...
                                            <div class="form-group mb-2">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4 mb_10">
                                                                <div class="star-container">
                                                                    <input type="radio" name="star-check" id="five-star"
                                                                        class="star-check" title="5"
                                                                        aria-invalid="false">
                                                                    <input type="radio" name="star-check" id="four-star"
                                                                        class="star-check" title="4"
                                                                        aria-invalid="false">
                                                                    <input type="radio" name="star-check"
                                                                        id="three-star" class="star-check" title="3"
                                                                        aria-invalid="false">
                                                                    <input type="radio" name="star-check" id="two-star"
                                                                        class="star-check" title="2"
                                                                        aria-invalid="false">
                                                                    <input type="radio" name="star-check" id="one-star"
                                                                        class="star-check" title="1"
                                                                        aria-invalid="false">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-8 mb_10">
                                                                @php
                                                                for($i=0;$i<$count;$i++){ @endphp <input type="text"
                                                                    class="form-control" name="behavioural"
                                                                    value="{{$beh_skills[$i]}}"><br>
                                                                    @php
                                                                    }
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control"
                                                            name="consul_assessment"></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control"
                                                            name="interview_availability"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
