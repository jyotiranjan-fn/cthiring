<x-admin-layout>
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">User Branch</h3></br>
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">User Branch
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="dropdown float-md-right">
                    <button class="btn btn-danger dropdown-toggle round btn-glow px-2" id="dropdownBreadcrumbButton" type="button" data-target="#info" data-toggle="modal" aria-haspopup="true">Add</button>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="card-content collpase show">
                                                            <div class="card-body">
                                                                ...
                                                                <form action="edit_user_branch/{{$loc->id}}" method="post" class="form">
                                                                    @csrf
                                                                    <div class="form-body">
                                                                        <div class="row">
                                                                            <div class="form-group col-12 mb-2">
                                                                                <label for="timesheetinput1">Branch Name:</label>
                                                                                <div class="position-relative has-icon-left">
                                                                                    <input type="text" id="timesheetinput1" class="form-control" name="location" value="{{$loc->location}}" placeholder="Enter User Branch Name">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="card-content collpase show">
                                                    <div class="card-body">
                                                        ...
                                                        <form action="add_branch" method="post" class="form">
                                                            @csrf
                                                            <div class="form-body">
                                                                <div class="row">
                                                                    <div class="form-group col-12 mb-2">
                                                                        <label for="timesheetinput1">Branch Name:</label>
                                                                        <div class="position-relative has-icon-left">
                                                                            <input type="text" id="timesheetinput1" class="form-control" name="location" placeholder="Enter User Branch Name">
                                                                            <div class="form-control-position">
                                                                                <i class="ft-map"></i>
                                                                            </div>
                                                                        </div>
