        ...
        <div class="content-header row">
                ...
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">View Qualification
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="dropdown float-md-right">
                    <button class="btn btn-danger round btn-glow px-2" id="dropdownBreadcrumbButton" type="button"
                        data-target="#info" data-toggle="modal" aria-haspopup="true">Add Qualification</button>
                </div>
            </div>
        </div>
                            ...
                            <table class="table table-striped table-bordered dataex-html5-selectors">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><i class="ft-edit text-success" data-toggle="modal"
                                                data-target="#edit{{ $loc->id }}"></i>
                                            <a href="{{url('/qualificationdelete',$loc->id)}}"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="card-content collpase show">
                                                    <div class="card-body">
                                                        <form action="editqualification/{{$loc->id}}" method="get"
                                                            class="form">
                                                            @csrf
                                                            <div class="form-body">
                                                                <div class="row">
                                                                    <div class="form-group col-12 mb-2">
                                                                        <label for="timesheetinput1">Qualification
                                                                            Name:</label>
                                                                        <div class="position-relative has-icon-left">
                                                                            <input type="text" id="timesheetinput1"
                                                                                class="form-control"
                                                                                name="qualification"
                                                                                value="{{$loc->qualification_name}}"
        ...
        <div class="modal-content">
            ...
            <div class="card-content collpase show">
                <div class="card-body">
                    ...
                    <form action="addqualification" method="post" class="form">
                        @csrf
                        <div class="form-body">
                            <div class="row">
                                <div class="form-group col-12 mb-2">
                                    ...
                                    <div class="position-relative has-icon-left">
                                        <input type="text" id="timesheetinput1" class="form-control"
                                            name="qualification" placeholder="Enter Qualification Name">
                                        <div class="form-control-position">
                                            <i class="ft-map"></i>
                                        </div>
                                    </div>
