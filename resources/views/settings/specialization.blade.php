<x-admin-layout>
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Specialization</h3></br>
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Specialization
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="dropdown float-md-right">
                    <button class="btn btn-danger round btn-glow px-2" id="dropdownBreadcrumbButton" type="button" data-target="#info" data-toggle="modal" aria-haspopup="true">Add Specialization</button>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="modal fade text-left" id="edit{{ $loc->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel11" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="editspecialization/{{$loc->id}}" method="get" class="form">
                                                    @csrf
                                                            ...
                                                            <div class="form-body">
                                                                <div class="row">
                                                                    <div class="form-group col-12 mb-2">
                                                                        <label for="timesheetinput1">Degree:</label>
                                                                ...
                                                                <div class="row">
                                                                    <div class="form-group col-12 mb-2">
                                                                        <label for="timesheetinput1">Specialization
                                                                            Name:</label>
                                                                        <div class="position-relative">
...
<div class="modal fade text-left" id="info" tabindex="-1" role="dialog" aria-labelledby="myModalLabel11" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="add_specialization" method="post" class="form">
                @csrf
                <div class="card-content collpase show">
                    <div class="card-body">
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="form-group col-12 mb-2">
                                    <label for="timesheetinput1">Specialization
                                        Name:</label>
                                    <div class="position-relative">
                                        <input type="text" id="timesheetinput1" class="form-control" name="specialization" placeholder="Enter Specialization Name">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
