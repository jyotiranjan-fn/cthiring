<x-admin-layout>
    <div class="content-header row">
      <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
        <h3 class="content-header-title mb-0 d-inline-block">User Designation</h3></br>
        <div class="row breadcrumbs-top d-inline-block">
          <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.html">Settings</a>
              </li>
              <li class="breadcrumb-item active">User Designation
              </li>
            </ol>
          </div>
        </div>
                          ...
                          <div class="modal-content">
                            ...
                            <div class="card-content collpase show">
                              <div class="card-body">
                                ...
                                <form action="edit_user_designation/{{$loc->id}}" method="get" class="form">
                                  @csrf
                                  <div class="form-body">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                      <div class="form-group col-12 mb-2">
                                        ...
                                        <div class="position-relative has-icon-left">
                                          <input type="text" id="timesheetinput1" value="{{$loc->mobile}}" class="form-control" placeholder="Add User Mobile No"  name="mobile">
                                          <div class="form-control-position">
                                            <i class="ft-map"></i>
                                          </div>
                                        </div>
                ...
                <div class="form-group">
                  <div class="modal fade text-left" id="info" tabindex="-1" role="dialog" aria-labelledby="myModalLabel11" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header bg-info white">
                          <h4 class="modal-title white" id="myModalLabel11">Add User Designation</h4>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                        <div class="card-content collpase show">
                          <div class="card-body">
                            ...
                            <form action="adduserdesignation" method="post" class="form">
                              @csrf
                              <div class="form-body">
                                <div class="row">
                                  <div class="form-group col-12 mb-2">
                                ...
                                <div class="row">
                                  <div class="form-group col-12 mb-2">
                                    ...
                                    <div class="position-relative has-icon-left">
                                      <input type="text" id="timesheetinput1" class="form-control" placeholder="Add User Mobile No" name="mobile">
                                      <div class="form-control-position">
                                        <i class="ft-map"></i>
                                      </div>
                                    </div>
